...
from db_config import creer_client_supabase, TABLE_APPLICATIONS
...
def main():
    ...
    try:
        ...
        print("\n👉 Exécutez le fichier 'supabase_add_remark.sql' dans l'éditeur SQL de Supabase pour créer la colonne !")
